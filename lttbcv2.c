...
static PyMethodDef lttbcv2_methods[] = {
    {
    ...
    {
        "downsample_y", // The name of the method
        downsample_y, // Function pointer to the method implementation
        METH_VARARGS,
        "Compute the largest triangle three buckets (LTTB) algorithm in a C extension."
    },
    {
        "downsample_y_index", // The name of the method
        downsample_y_index, // Function pointer to the method implementation
        METH_VARARGS,
        "Compute the largest triangle three buckets (LTTB) algorithm in a C extension."
    },
    {
